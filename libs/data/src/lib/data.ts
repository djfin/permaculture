...
export class Project {
    ...
    constructor(name:string, description:string){
        ...
        //Principle 1
        const princ1 = new Principle(0,"Observe and Interact", "By taking the time to engage with nature we can design solutions that suit our particular situation.");
        ...
        //Principle 2
        const princ2 = new Principle(1,"Catch and Store Energy", "By developing systems that collect resources when they are abundant, we can use them in times of need.");
        ...
        //Principle 3
        const princ3 = new Principle(2,"Obtain a Yield", "Ensure that you are getting truly useful rewards as part of the work that you are doing.");
        ...
        //Principle 4
        const princ4 = new Principle(3,"Apply Self Regulation and Accept Feedback", "We need to discourage inappropriate activity to ensure that systems can continue to function well.");
        ...
        //Principle 5
        const princ5 = new Principle(4,"Use and Value Renewable Resources and Services", "Make the best use of nature’s abundance to reduce our consumptive behaviour and dependence on non-renewable resources.");
        ...
        //Principle 6
        const princ6 = new Principle(5,"Produce No Waste", "By valuing and making use of all the resources that are available to us, nothing goes to waste.");
        ...
        //Principle 7
        const princ7 = new Principle(6,"Design From Patterns to Details", "By stepping back, we can observe patterns in nature and society. These can form the backbone of our designs, with the details filled in as we go.");
        ...
        //Principle 8
        const princ8 = new Principle(7,"Integrate Rather Then Segregate", "By putting the right things in the right place, relationships develop between them and they support each other.");
        ...
        //Principle 9
        const princ9 = new Principle(8,"Use Small and Slow Solutions", "Small and slow systems are easier to maintain than big ones, making better use of local resources and produce more sustainable outcomes.");
        ...
        //Principle 10
        const princ10 = new Principle(9,"Use and Value Diversity", "Diversity reduces vulnerability to a variety of threats and takes advantage of the unique nature of the environment in which it resides.");
        ...
        //Principle 11
        const princ11 = new Principle(10,"Use Edges and Value the Marginal", "The interface between things is where the most interesting events take place. These are often the most valuable, diverse and productive elements in the system.");
        ...
        //Priciple 112
        const princ12 = new Principle(11,"Creatively Use and Respond to Change", "We can have a positive impact on inevitable change by carefully observing, and then intervening at the right time.");
