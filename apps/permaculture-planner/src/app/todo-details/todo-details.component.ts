...
export class TodoDetailsComponent implements OnInit {
  ...
  fetch(){
    ...
    const reqString = 'api/users/'+this.userId+'/projects/'+this.projectId+'/garden/'+this.zoneName+'/beds/'+this.gardenBedName+'/crops/'+this.cropName+'/todos/'+this.todoName;
  ...
  toggleCompleteToDo(){
    const reqString = 'api/users/'+this.userId+'/projects/'+this.projectId+'/garden/'+this.zoneName+'/beds/'+this.gardenBedName+'/crops/'+this.cropName+'/todos/'+this.todoName+'/complete';
    const response = this.http.put(reqString, {})
